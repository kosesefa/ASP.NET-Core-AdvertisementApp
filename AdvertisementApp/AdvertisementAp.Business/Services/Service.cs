using AdvertisementAp.Business.Extensions;
...
namespace AdvertisementAp.Business.Services
{
        ...
        where T : BaseEntity
    {
        ...
        public async Task<IResponse<IDto>> GetByIdAsync<IDto>(int id)
        {
            ...
            if (data == null)
                return new Response<IDto>(ResponseType.NotFound, $"{id}ID'ye ait data bulunamadı.");
        ...
        public async Task<IResponse> RemoveAsync(int id)
        {
            ...
            if (data == null)
                return new Response(ResponseType.NotFound, $"{id}ID'ye ait data bulunamadı.");
        ...
        public async Task<IResponse<UpdateDto>> UpdateAsync(UpdateDto dto)
        {
            ...
            if (result.IsValid)
            {
                ...
                if (unchangedData == null)
                    return new Response<UpdateDto>(ResponseType.NotFound, $"{dto.Id}ID'ye ait data bulunamadı.");
